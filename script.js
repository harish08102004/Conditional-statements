...
submitButton1.onclick = () => {
  ...
  if (0<=numberInput1 && numberInput1<=19){
    message1='That was a terrible score!';
  }else if(20<=numberInput1 && numberInput1<=39){
    message1='You know some things. Needs improvement';
  }else if(40<=numberInput1 && numberInput1<=69){
    message1='You did a passable job, not bad!';
  }else if(70<=numberInput1 && numberInput1<=89){
    message1="That's a great score. You really know your stuff.";
  }else if(90<=numberInput1 && numberInput1<=100){
      message1='What an amazing score!';
  }else{
      message1='This is not possible. An error occured';
  }
...
submitButton2.onclick = () => {
  ...
  // Score of 90 to 100 — “What an amazing score!”
  switch(true){
  case(0<=numberInput1 && numberInput1<=19):
    message2='That was a terrible score!';
    break;
   case(10<=numberInput1 && numberInput1<=39):
    message2='You know some things. Needs improvement';
    break;
    case(40<=numberInput1 && numberInput1<=69):
    message2='You did a passable job, not bad!';
    break;
   case(70<=numberInput1 && numberInput1<=89):
    message2="That's a great score. You really know your stuff.";
    break;
   case(90<=numberInput1 && numberInput1<=100):
      message2='What an amazing score!';
    break;
   default:
      message2='This is not possible. An error occured';
  }
